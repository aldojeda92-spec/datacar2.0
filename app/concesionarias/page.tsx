        ...
        <div className="w-full max-w-md bg-[#FFFFFF] border-t-4 border-[#0A1F33] border-l border-r border-b border-[#C0C0C0] p-8 shadow-none rounded-none">
          ...
          {authView === 'login' ? (
            <form onSubmit={handleLogin} className="flex flex-col gap-4">
              <div><label className="text-[10px] font-bold text-[#3A3A3C] uppercase block mb-1">Correo Corporativo</label><input type="email" required className="w-full border border-[#C0C0C0] p-3 text-xs focus:outline-none focus:border-[#0A1F33] bg-[#F8F9FA] rounded-none" value={loginEmail} onChange={e=>setLoginEmail(e.target.value)} /></div>
              <div><label className="text-[10px] font-bold text-[#3A3A3C] uppercase block mb-1">Contraseña</label><input type="password" required className="w-full border border-[#C0C0C0] p-3 text-xs focus:outline-none focus:border-[#0A1F33] bg-[#F8F9FA] rounded-none" value={loginPassword} onChange={e=>setLoginPassword(e.target.value)} /></div>
            ...
            <form onSubmit={handleRequestAccess} className="flex flex-col gap-4">
              ...
              <div><label className="text-[10px] font-bold text-[#3A3A3C] uppercase block mb-1">Nombre Completo</label><input type="text" required className="w-full border border-[#C0C0C0] p-3 text-xs focus:outline-none focus:border-[#00BFFF] bg-[#FFFFFF] rounded-none" value={reqForm.nombre} onChange={e=>setReqForm({...reqForm, nombre: e.target.value})} /></div>
              <div className="grid grid-cols-2 gap-4">
                <div><label className="text-[10px] font-bold text-[#3A3A3C] uppercase block mb-1">Cargo</label><input type="text" required placeholder="Ej: Gerente" className="w-full border border-[#C0C0C0] p-3 text-xs focus:outline-none focus:border-[#00BFFF] bg-[#FFFFFF] rounded-none" value={reqForm.cargo} onChange={e=>setReqForm({...reqForm, cargo: e.target.value})} /></div>
                <div><label className="text-[10px] font-bold text-[#3A3A3C] uppercase block mb-1">Concesionaria</label><input type="text" required placeholder="Ej: Garden" className="w-full border border-[#C0C0C0] p-3 text-xs focus:outline-none focus:border-[#00BFFF] bg-[#FFFFFF] rounded-none" value={reqForm.concesionaria} onChange={e=>setReqForm({...reqForm, concesionaria: e.target.value})} /></div>
              </div>
              <div><label className="text-[10px] font-bold text-[#3A3A3C] uppercase block mb-1">Marcas que representan</label><input type="text" required placeholder="Ej: Kia, Nissan" className="w-full border border-[#C0C0C0] p-3 text-xs focus:outline-none focus:border-[#00BFFF] bg-[#FFFFFF] rounded-none" value={reqForm.marcas} onChange={e=>setReqForm({...reqForm, marcas: e.target.value})} /></div>
              <div className="grid grid-cols-2 gap-4">
                <div><label className="text-[10px] font-bold text-[#3A3A3C] uppercase block mb-1">Teléfono Directo</label><input type="tel" required className="w-full border border-[#C0C0C0] p-3 text-xs focus:outline-none focus:border-[#00BFFF] bg-[#FFFFFF] rounded-none" value={reqForm.telefono} onChange={e=>setReqForm({...reqForm, telefono: e.target.value})} /></div>
                <div><label className="text-[10px] font-bold text-[#3A3A3C] uppercase block mb-1">Email Corporativo</label><input type="email" required className="w-full border border-[#C0C0C0] p-3 text-xs focus:outline-none focus:border-[#00BFFF] bg-[#FFFFFF] rounded-none" value={reqForm.email} onChange={e=>setReqForm({...reqForm, email: e.target.value})} /></div>
              </div>
              ...
              <div className="bg-[#FFFFFF] border border-[#C0C0C0] flex flex-col min-h-[500px]">
                <div className="p-4 bg-[#F5F5F5] border-b border-[#C0C0C0] flex flex-col md:flex-row justify-between items-center gap-4">
                  ...
                  <div className="flex flex-wrap gap-2 w-full md:w-auto">
                    ...
                    <input type="text" placeholder="Buscar versión..." className="border border-[#C0C0C0] px-3 py-2 text-xs w-full md:w-48 focus:outline-none focus:border-[#0A1F33] bg-[#FFFFFF] rounded-none" value={inventarioSearch} onChange={e => setInventarioSearch(e.target.value)} />
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-[#FFFFFF] border border-[#C0C0C0] p-6 h-fit">
                  ...
                  <form onSubmit={handleSaveModelo} className="flex flex-col gap-4">
                    <div>
                      <label className="text-[10px] font-bold text-[#3A3A3C] uppercase block mb-1">Marca Permitida</label>
                      <select className="w-full border p-3 text-xs focus:outline-none focus:border-[#0A1F33] rounded-none" value={modeloForm.brandId} onChange={e => setModeloForm({...modeloForm, brandId: e.target.value})} required>
                        <option value="">Seleccionar marca...</option>
                        {permittedBrandsObjects.map(m => <option key={m.id} value={m.id}>{m.name.toUpperCase()}</option>)}
                      </select>
                    </div>
                    <div><label className="text-[10px] font-bold text-[#3A3A3C] uppercase block mb-1">Nombre del Modelo</label><input type="text" className="w-full border p-3 text-xs focus:outline-none focus:border-[#0A1F33] rounded-none" value={modeloForm.name} onChange={e => setModeloForm({...modeloForm, name: e.target.value})} placeholder="Ej: Sportage" required /></div>
                    <div className="grid grid-cols-2 gap-4">
                      <div><label className="text-[10px] font-bold text-[#3A3A3C] uppercase block mb-1">Categoría</label><input type="text" className="w-full border p-3 text-xs focus:outline-none focus:border-[#0A1F33] rounded-none" value={modeloForm.tipo_carroceria} onChange={e => setModeloForm({...modeloForm, tipo_carroceria: e.target.value})} placeholder="Ej: SUV" /></div>
                      <div><label className="text-[10px] font-bold text-[#3A3A3C] uppercase block mb-1">Origen Fabrica</label><input type="text" className="w-full border p-3 text-xs focus:outline-none focus:border-[#0A1F33] rounded-none" value={modeloForm.origen} onChange={e => setModeloForm({...modeloForm, origen: e.target.value})} /></div>
                    </div>
                    <div><label className="text-[10px] font-bold text-[#3A3A3C] uppercase block mb-1">URL Imagen</label><input type="url" className="w-full border p-3 text-xs focus:outline-none focus:border-[#0A1F33] rounded-none" value={modeloForm.imgUrl} onChange={e => setModeloForm({...modeloForm, imgUrl: e.target.value})} placeholder="https://..." /></div>
                ...
                <div className="bg-[#FFFFFF] border border-[#C0C0C0] p-6 h-fit">
                  ...
                  <form onSubmit={handleSaveVersion} className="flex flex-col gap-4">
                    <div>
                      ...
                      <select className="w-full border p-3 text-xs focus:outline-none focus:border-[#00BFFF] rounded-none" value={versionForm.modelId} onChange={e => setVersionForm({...versionForm, modelId: e.target.value})} required>
                    ...
                    <div><label className="text-[10px] font-bold text-[#3A3A3C] uppercase block mb-1">Nombre de Versión</label><input type="text" className="w-full border p-3 text-xs focus:outline-none focus:border-[#00BFFF] rounded-none" value={versionForm.name} onChange={e => setVersionForm({...versionForm, name: e.target.value})} placeholder="Ej: 2.0 EX AT" required /></div>
                    <div className="grid grid-cols-2 gap-4">
                      <div><label className="text-[10px] font-bold text-[#3A3A3C] uppercase block mb-1">Precio (USD)</label><input type="number" className="w-full border p-3 text-xs focus:outline-none focus:border-[#00BFFF] rounded-none" value={versionForm.price} onChange={e => setVersionForm({...versionForm, price: e.target.value})} required /></div>
                      <div><label className="text-[10px] font-bold text-[#3A3A3C] uppercase block mb-1">Transmisión</label><input type="text" className="w-full border p-3 text-xs focus:outline-none focus:border-[#00BFFF] rounded-none" value={versionForm.transmision} onChange={e => setVersionForm({...versionForm, transmision: e.target.value})} /></div>
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                      <div><label className="text-[10px] font-bold text-[#3A3A3C] uppercase block mb-1">Combustible</label><input type="text" className="w-full border p-3 text-xs focus:outline-none focus:border-[#00BFFF] rounded-none" value={versionForm.combustible} onChange={e => setVersionForm({...versionForm, combustible: e.target.value})} /></div>
                      <div><label className="text-[10px] font-bold text-[#3A3A3C] uppercase block mb-1">Plazas</label><input type="number" className="w-full border p-3 text-xs focus:outline-none focus:border-[#00BFFF] rounded-none" value={versionForm.plazas} onChange={e => setVersionForm({...versionForm, plazas: e.target.value})} /></div>
                    </div>
