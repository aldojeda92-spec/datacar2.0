...
export default function NegociamosClient() {
  ...
  return (
    <main className="min-h-screen bg-[#F8F9FA] text-[#3A3A3C] font-sans flex flex-col">
      ...
      <section className="w-full bg-[#FFFFFF] border-b border-[#C0C0C0] py-12 md:py-20 relative overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto px-4 lg:px-8 flex flex-col lg:flex-row gap-16 relative z-10">
          ...
          <div className="lg:w-1/2 flex flex-col justify-center">
            ...
            <h1 className="font-black text-4xl md:text-6xl text-[#0A1F33] uppercase leading-[1.1] mb-6" style={{ fontFamily: 'var(--font-montserrat), sans-serif' }}>
              Basta de <span className="text-[#00BFFF]">lidiar</span> con concesionarias.
            </h1>
            <p className="text-sm md:text-base text-[#3A3A3C] leading-relaxed mb-8 font-medium" style={{ fontFamily: 'var(--font-inter), sans-serif' }}>
            ...
            <div className="flex flex-wrap items-stretch border border-[#C0C0C0] bg-[#FFFFFF] w-full sm:w-max">
              <div className="bg-[#0A1F33] text-[#FFFFFF] p-4 flex flex-col justify-center border-r border-[#0A1F33]">
                ...
                <span className="font-black text-3xl" style={{ fontFamily: 'var(--font-montserrat), sans-serif' }}>US$ 200</span>
              </div>
          ...
          <div className="lg:w-1/2 w-full">
            <div className="bg-[#FFFFFF] border-t-4 border-[#0A1F33] border-l border-r border-b border-[#C0C0C0] p-8 md:p-10 shadow-none rounded-none">
              <h2 className="font-black text-2xl text-[#0A1F33] uppercase mb-2" style={{ fontFamily: 'var(--font-montserrat), sans-serif' }}>Elegí tu próximo auto</h2>
        ...
        <div className="max-w-[1200px] mx-auto px-4 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          <div className="bg-[#FFFFFF] border border-[#C0C0C0] p-8 relative z-10 hover:border-[#0A1F33] transition-colors rounded-none">
            <div className="flex justify-between items-start mb-6">
              ...
              <span className="font-black text-4xl text-[#C0C0C0]/30" style={{ fontFamily: 'var(--font-montserrat), sans-serif' }}>01</span>
            </div>
            <h3 className="font-black text-lg text-[#0A1F33] uppercase mb-3" style={{ fontFamily: 'var(--font-montserrat), sans-serif' }}>Elegís el auto</h3>
            <p className="text-[12px] text-[#3A3A3C] font-medium leading-relaxed" style={{ fontFamily: 'var(--font-inter), sans-serif' }}>Partimos del modelo exacto que tenés en mente. Si tenés dudas, nuestro equipo técnico te audita las mejores opciones según tu presupuesto real.</p>
          </div>
          ...
          <div className="bg-[#0A1F33] border-t-4 border-[#00BFFF] p-8 relative z-10 shadow-none text-[#FFFFFF] transform md:-translate-y-4 rounded-none">
            <div className="flex justify-between items-start mb-6">
              ...
              <span className="font-black text-4xl text-[#FFFFFF]/10" style={{ fontFamily: 'var(--font-montserrat), sans-serif' }}>02</span>
            </div>
            <h3 className="font-black text-lg text-[#FFFFFF] uppercase mb-3" style={{ fontFamily: 'var(--font-montserrat), sans-serif' }}>Negociamos por vos</h3>
            <p className="text-[12px] text-[#C0C0C0] font-medium leading-relaxed" style={{ fontFamily: 'var(--font-inter), sans-serif' }}>Rastreamos el stock en todas las concesionarias del país. Comparamos condiciones, eliminamos cotizaciones infladas y cerramos el mejor precio de contado o financiado.</p>
          </div>
          ...
          <div className="bg-[#FFFFFF] border border-[#C0C0C0] p-8 relative z-10 hover:border-[#0A1F33] transition-colors rounded-none">
            <div className="flex justify-between items-start mb-6">
              ...
              <span className="font-black text-4xl text-[#C0C0C0]/30" style={{ fontFamily: 'var(--font-montserrat), sans-serif' }}>03</span>
            </div>
            <h3 className="font-black text-lg text-[#0A1F33] uppercase mb-3" style={{ fontFamily: 'var(--font-montserrat), sans-serif' }}>Blindamos el cierre</h3>
            <p className="text-[12px] text-[#3A3A3C] font-medium leading-relaxed" style={{ fontFamily: 'var(--font-inter), sans-serif' }}>Auditamos los papeles de facturación, coordinamos los pagos seguros con la agencia y te acompañamos logísticamente hasta que tenés la llave en la mano.</p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full bg-[#FFFFFF] py-20 border-b border-[#C0C0C0]">
        <div className="max-w-[1000px] mx-auto px-4 lg:px-8">
          <h2 className="text-3xl text-[#3A3A3C] font-medium mb-12 text-center md:text-left" style={{ fontFamily: 'var(--font-inter), sans-serif' }}>
            ...
            {faqs.map((faq, index) => (
              <div key={index} className="border border-[#C0C0C0] bg-[#F8F9FA] p-6 hover:border-[#0A1F33] transition-colors rounded-none">
                <button onClick={() => setOpenFaq(openFaq === index ? null : index)} className="w-full flex justify-between items-center text-left focus:outline-none group bg-transparent border-none outline-none">
                  <span className="font-bold text-xs text-[#0A1F33] uppercase tracking-wide pr-4" style={{ fontFamily: 'var(--font-inter), sans-serif' }}>{faq.q}</span>
                ...
                <div className={`overflow-hidden transition-all duration-300 ease-in-out ${openFaq === index ? 'max-h-40 opacity-100 mt-4 pt-4 border-t border-[#C0C0C0]/50' : 'max-h-0 opacity-0'}`}>
                  <p className="text-[11px] text-[#3A3A3C] leading-relaxed font-medium" style={{ fontFamily: 'var(--font-inter), sans-serif' }}>{faq.a}</p>
                </div>
              </div>
            ))}
          </div>
